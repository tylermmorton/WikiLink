 ...
 * Element inside of a screen that is meant to draw a centered string within a
 * set width. If the str is longer than the width, it will shorten it to fit and
 * add "..." to the end.
 * 
...
public class WidgetShortenedString extends Widget
{
    ...
    /**
     * setColor<br>
     * Set the color of the string to be displayed on the screen. Default color
     * is 0xFFFFFF.
     * **/
