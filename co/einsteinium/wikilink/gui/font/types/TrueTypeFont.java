package co.einsteinium.wikilink.gui.font.types;
 ...
 * 
 * Thanks to ProfMobius / everyone involved for figuring this out. :)
 */
...
public class TrueTypeFont
{
			...
			float srcX, float srcY, float srcX2, float srcY2)
	{
		...
		t.addVertexWithUV(drawX, drawY + DrawHeight, 0, TextureSrcX,
				TextureSrcY + RenderHeight);
		// GL11.glTexCoord2f(TextureSrcX, TextureSrcY + RenderHeight);
		// GL11.glVertex2f(drawX, drawY + DrawHeight);

		t.addVertexWithUV(drawX + DrawWidth, drawY + DrawHeight, 0, TextureSrcX
				+ RenderWidth, TextureSrcY + RenderHeight);
		// GL11.glTexCoord2f(TextureSrcX + RenderWidth, TextureSrcY +
		// RenderHeight);
		// GL11.glVertex2f(drawX + DrawWidth, drawY + DrawHeight);

		t.addVertexWithUV(drawX + DrawWidth, drawY, 0, TextureSrcX
				+ RenderWidth, TextureSrcY);
		// GL11.glTexCoord2f(TextureSrcX + RenderWidth, TextureSrcY);
	...
	public void drawString(float x, float y, String whatchars, int startIndex,
			int endIndex, float scaleX, float scaleY, int format, float... rgba)
	{
			...
			if (intObject != null)
			{
				...
				} else
				{
					drawQuad((totalwidth + intObject.width) + x / scaleX,
							startY + y / scaleY, totalwidth + x / scaleX,
